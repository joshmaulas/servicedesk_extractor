...
<div class="navbar navbar-inner block-header">
    <div class="muted pull-left">Product Mix Reports</div>
...
<div class="block-content collapse in">
    ...
    ?>
     ...
     <div class="span3">
     	<button class="btn" onclick="gen_table(this)" data-report-name='pmix_table_form'><i class="icon-list-alt" id="gene"></i> Generate</button>
     </div>
