...
<div class="navbar navbar-inner block-header">
    <div class="muted pull-left">Monthly Reports - <?= $report_type1."_".$month."-".$year?></div>
    <div class="pull-right"><a href="<?php echo base_url();?>pages/download/<?=$report_type1?>_sales_report_<?=$month."-".$year;?>.csv"><span class="badge badge-warning">Download File</span></a></div>
</div>
