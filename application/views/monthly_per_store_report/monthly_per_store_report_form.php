...
<div class="navbar navbar-inner block-header">
    <div class="muted pull-left">Monthly Reports Per Store</div>
...
<div class="block-content collapse in">
    ...
    ?>
     ...
     <div class="span3">
     	<button class="btn" onclick="gen_table(this)" data-report-name='monthly_per_store_table_form'><i class="icon-list-alt" id="gene"></i> Generate</button>
     </div>
